...
[2] I am having difficulty with the confidence intervals. I was using the code from Module 12, but it's not running effectively when I try and input it into my figure. I'm not sure what exactly is leading to this problem and could use any and all help and suggestions. I also still had issues with this, my code from Module 12 wasn't synthesizing very well and I'm not sure why it wasn't running properly. Reese helped me a lot with this and their comments were very kind and useful. However, I am still stuck. I can't get it to run properly even after removing yhat and creating df as a data frame instead of a matrix. I think I may just not be understanding something important and could use a little guidance onto where I am going astray.
...
ci
df <- data.frame()
df <- cbind(x, y, ci) #binding our x value with CI
names(df) <- c("x", "y", "CIfit", "CIlwr", "CIupr")
head(df)
library(ggplot2) 
g <- ggplot(data = df, aes(x = log_longevity, y = log_brain_size))
g <- g + geom_point()
